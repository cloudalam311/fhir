...
export declare type tokenEndpointAuthMethod = 'client_secret_basic' | 'client_secret_post' | 'private_key_jwt';
/**
...
export interface SmartStrategy extends OAuthStrategy {
     ...
     */
    capabilities: ('launch-ehr' | 'launch-standalone' | 'client-public' | 'client-confidential-symmetric' | 'sso-openid-connect' | 'context-passthrough-banner' | 'context-passthrough-style' | 'context-ehr-patient' | 'context-ehr-encounter' | 'context-standalone-patient' | 'context-standalone-encounter' | 'permission-offline' | 'permission-patient' | 'permission-user' | string)[];
    /**
