...
export interface BulkDataAuth {
    operation: 'initiate-export' | 'initiate-import' | 'get-status-export' | 'get-status-import' | 'cancel-export' | 'cancel-import';
    exportType?: ExportType;
    importResources?: string[];
}
export declare type VerbType = 'CONNECT' | 'DELETE' | 'GET' | 'HEAD' | 'OPTIONS' | 'PATCH' | 'POST' | 'PUT' | 'TRACE';
/**
